<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="SanPham.aspx.cs" Inherits="SanPham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div class="stylemainSP">
       ...
       <div class="styleheader3SP">
           ...
           <asp:DataList ID="dtSanPham" runat="server">
               <ItemTemplate>
       ...
       <div class="phantrang"><cc2:CollectionPager ID="CollectionPager2" runat="server" ResultsFormat="{0}->{1} (của {2}) Sản phẩm" ShowFirstLast="True" SliderSize="5" PagingMode="PostBack"></cc2:CollectionPager></div>
