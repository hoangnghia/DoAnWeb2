<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="contentHome">
        ...
        <div class="content1">
           <div class="SanPham">
               <div class="icon">
                   <a href="ThongKe.aspx"><img src="../images/report.png" style="height: 73px; width: 64px" /></a>
               </div>
                <div class="icon">
                    Báo Cáo
               </div>
        ...
        <div class="stylecontentDonHang">
         <asp:DataList ID="dtDonHang" runat="server">
               <ItemTemplate>
                   ...
                   <div class="styleCot10"><a href='<%# "QuanLyChiTietDonHang.aspx?ID="+Eval("ID") %>'><img src="../images/Next.png" style=" Width: 43px; Height: 30px;" /></a> </div>
               </ItemTemplate>
           </asp:DataList>
            </div>
        </div>
