<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="HoiDap.aspx.cs" Inherits="HoiDap" %>
              ...
              <asp:DataList ID="dtHoiDap" runat="server">
               <ItemTemplate>
                  ...
                  <div class="StyleTop2"><div class="textTM"><asp:Label ID="lbTieuDe" runat="server" Text='<%# Bind("TieuDe") %>'></asp:Label></div></div>
                   <div class="StyleTop2"><div class="textTM"><div style="width:900px; height : 300px;"><asp:Label ID="lbNoiDung" runat="server" Text='<%# Bind("NoiDung") %>'></asp:Label></div></div></div>
               </ItemTemplate>
           </asp:DataList>
           </div>
        </div>
