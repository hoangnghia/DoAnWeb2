...
public partial class SuaSanPham : System.Web.UI.Page
{
    ...
    private void Bind()
    {
        ...
        foreach (DataListItem item in ltSanPham.Items)
        {
            ...
            DropDownList2.DataValueField = "MaDM";
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else if (FileUpload2.HasFile & FileUpload3.HasFile & FileUpload4.HasFile)
        {
            ...
            file3 = file3.Replace(":", "");
            String pathSave = Server.MapPath("\\images\\");
            FileUpload2.PostedFile.SaveAs(pathSave + file1);
            FileUpload3.PostedFile.SaveAs(pathSave + file2);
            FileUpload4.PostedFile.SaveAs(pathSave + file3);
        ...
        else if (FileUpload2.HasFile & FileUpload3.HasFile)
        {
            ...
            file3 = file3.Replace(":", "");
            String pathSave = Server.MapPath("\\images\\");
            FileUpload2.PostedFile.SaveAs(pathSave + file2);
            FileUpload3.PostedFile.SaveAs(pathSave + file3);
        ...
        else if (FileUpload3.HasFile & FileUpload4.HasFile)
        {
            ...
            String pathSave = Server.MapPath("\\images\\");
            FileUpload3.PostedFile.SaveAs(pathSave + file3);
            FileUpload4.PostedFile.SaveAs(pathSave + file4);
            string path2 = "../images/" + file3.ToString();
