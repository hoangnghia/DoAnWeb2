<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="SuaDanhMuc.aspx.cs" Inherits="SuaDanhMuc" %>
     ...
     <div class="stylemain">
        ...
        <div class="styleheader2SDM">
                ...
                <div class="stylecontent">
                    <div class="style2SDM"> <asp:Label ID="txtMaDM" runat="server" Text='<%# Bind("MaDM") %>'></asp:Label></div>
