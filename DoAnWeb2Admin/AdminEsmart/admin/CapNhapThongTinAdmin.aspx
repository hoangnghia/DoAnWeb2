<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="CapNhapThongTinAdmin.aspx.cs" Inherits="CapNhapThongTinAdmin" %>
    ...
    <asp:DataList ID="datalistsuanguoidung" runat="server" CssClass="cldtlsnguoidung" class ="cldtlsnguoidung">
        <ItemTemplate>
         ...
         <div id="idsumand"><div id="chu">Mã ND </div>  <div id="thongtin"><asp:TextBox ID="txtMaND" runat="server" CssClass="cstxtsmand" Class="cstxtsmand" Enabled="false" Text ='<%# Bind("MaND") %>'></asp:TextBox> </div></div>
             ...
             <div id="idsdienthoai"> <div id="chu"> Điện thoại </div> <div id="thongtin"> <asp:TextBox ID="txtDienThai" runat="server" CssClass="cltxtsdienthoai" Class="cltxtsdienthoai" Text ='<%# Bind("SoDienThoai") %>'></asp:TextBox> </div></div>
