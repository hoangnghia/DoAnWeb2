<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="SuaNguoiDung.aspx.cs" Inherits="SuaNguoiDung" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id ="toanbo">
        <div id ="tieudechucnang">
         <div id="tentieude">Sửa Người Dùng</div>       
         </div>
    ...
    <asp:DataList ID="datalistsuanguoidung" runat="server" OnSelectedIndexChanged="datalistsuanguoidung_SelectedIndexChanged" CssClass="cldtlsnguoidung" class ="cldtlsnguoidung">
        <ItemTemplate>
         ...
         <div id="idsumand"><div id="chu">Mã ND </div>  <div id="thongtin"><asp:TextBox ID="txtMaND" runat="server" CssClass="cstxtsmand" Class="cstxtsmand" Enabled="false" Text ='<%# Bind("MaND") %>'></asp:TextBox> </div></div>
             <div id="idstaikhoan"><div id="chu">Tài Khoản </div>  <div id="thongtin"><asp:TextBox ID="txtTaiKhoan" Enabled="false" runat="server"  CssClass="cltxtstaikhoan" Class="cltxtstaikhoan" Text ='<%# Bind("TaiKhoan") %>'></asp:TextBox> </div></div>
             ...
             <div id="idsngaysinh"><div id="chu">Ngày Sinh </div><div id="thongtin"> <asp:TextBox ID="txtNgaySinh" runat="server" CssClass="cltxtsngaysinh" Class="cltxtsngaysinh" Text='<%# Bind("NgaySinh") %>'></asp:TextBox> </div>
                <div id="lichsuanguoidung">
                    <asp:Calendar ID="Calendar2" runat="server" ShowTimeSelector="true" DateFormat="yyyy-MM-dd" DatePickerMode="fale" OnSelectionChanged ="Calendar2_SelectionChanged" CssClass="clcldslich" Class="clcldslich"></asp:Calendar> 
                </div>
             </div> 
             <div id="idsgioitinh">
