<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="QuanLyChiTietDonHang.aspx.cs" Inherits="QuanLyChiTietDonHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div id="toanbo">
         ...
         <div id="tentieude">Quản Lý Chi Tiết Đơn Hàng</div> <div id="themxoa"><div id="chucnangthem"><a href ='ThemChiTietDonHang.aspx' >Sửa</a> </div> <div id="chucnangxoa"> <asp:Button ID="btnXoaChiTietDonHang" Visible="false" runat="server" OnClick="btnXoaChiTietDonHang_Click" Text="Xóa" Class ="clbtnxoanguoidung" CssClass="clbtnxoanguoidung"/> </div></div>              
         </div>
