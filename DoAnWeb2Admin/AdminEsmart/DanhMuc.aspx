<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="DanhMuc.aspx.cs" Inherits="Slide" %>
        ...
        <div class="styleheader2">
            <div class="style5"><p>Chọn</p></div>
                ...
                <div class="stylecontent">
                    ...
                    <div class="style2"> <asp:Label ID="lbMaDM" runat="server" Text='<%# Bind("ID") %>'></asp:Label></div>
                    <div class="style3"> <asp:Label ID="lbTenDM" runat="server" Text='<%# Bind("TenDM") %>'></asp:Label></div>
                    <div class="style6"><a href='<%# "SuaDanhMuc.aspx?ID="+Eval("ID") %>'><img src="images/update.png" style=" Width: 28px; Height: 16px;" /></a></div>
                </div>   
        </ItemTemplate>
    </asp:DataList>
